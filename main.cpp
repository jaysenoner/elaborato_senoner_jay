    ...
    do {
        ...
        switch (choice) {
            ...
            case 1:
                ...
                std::cout << "Insert the amount of money(positive or negative) involved in the transaction"
                          << std::endl;
                std::cin >> sum;
                ...
                myBank.writeTransaction(
                        myBank.addTransaction(Transaction(description, sum, myBank.getMyIban(), *date, *hour)));
                break;
